# Hunt Jeopardy — Class 1 | Schema

> Campaign: Class 1 | Environment: SCHEMA | Base Score: 180 pts | Env Multiplier: 1.75×

---

## Scoring Formula

Risk Score = 180 (base) × 1.75 (env) × domain privilege multiplier

| Domain | Privilege Multiplier | Score per Card |
|--------|---------------------|----------------|
| 🔐 Active Directory | 3× | **945 pts** |
| 🗝️ Secrets/Identity | 2× | **630 pts** |
| 🖥️ Infrastructure | 2× | **630 pts** |
| 📱 Applications | 1× | **315 pts** |

**Total Available Points: 25200 pts** (40 cards — trifecta required for each)
...
block-beta
  columns 5
  HT["Hunt Type"] AD["🔐 Active Directory\n945 pts"] SEC["🗝️ Secrets/Identity\n630 pts"] INFRA["🖥️ Infrastructure\n630 pts"] APPS["📱 Applications\n315 pts"]
  ROW1["1 · Scheduled Tasks"] A1["945"] B1["630"] C1["630"] D1["315"]
  ROW2["2 · Process Spawning"] A2["945"] B2["630"] C2["630"] D2["315"]
  ROW3["3 · Service Creation"] A3["945"] B3["630"] C3["630"] D3["315"]
  ROW4["4 · Package Manager"] A4["945"] B4["630"] C4["630"] D4["315"]
  ROW5["5 · Data Staging"] A5["945"] B5["630"] C5["630"] D5["315"]
  ROW6["6 · Lateral Movement"] A6["945"] B6["630"] C6["630"] D6["315"]
  ROW7["7 · Registry Persistence"] A7["945"] B7["630"] C7["630"] D7["315"]
  ROW8["8 · Privilege Escalation"] A8["945"] B8["630"] C8["630"] D8["315"]
  ROW9["9 · Net Share Enum"] A9["945"] B9["630"] C9["630"] D9["315"]
  ROW10["10 · Cloud Anomalies"] A10["945"] B10["630"] C10["630"] D10["315"]
```
...
**Risk Score: 630 pts** | Trifecta Required (CTI + Hunt + Detection)
...
**Risk Score: 315 pts** | Trifecta Required (CTI + Hunt + Detection)
