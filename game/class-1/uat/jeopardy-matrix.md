# Hunt Jeopardy — Class 1 | UAT

> Campaign: Class 1 | Environment: UAT | Base Score: 180 pts | Env Multiplier: 1.5×

---

## Scoring Formula

Risk Score = 180 (base) × 1.5 (env) × domain privilege multiplier
