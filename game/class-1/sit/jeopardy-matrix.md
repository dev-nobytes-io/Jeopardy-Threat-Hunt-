# Hunt Jeopardy — Class 1 | SIT

> Campaign: Class 1 | Environment: SIT | Base Score: 180 pts | Env Multiplier: 0.75×

---

## Scoring Formula

Risk Score = 180 (base) × 0.75 (env) × domain privilege multiplier

| Domain | Privilege Multiplier | Score per Card |
|--------|---------------------|----------------|
| 🔐 Active Directory | 3× | **405 pts** |
| 🗝️ Secrets/Identity | 2× | **270 pts** |
| 🖥️ Infrastructure | 2× | **270 pts** |
| 📱 Applications | 1× | **135 pts** |

**Total Available Points: 10800 pts** (40 cards — trifecta required for each)
...
block-beta
  columns 5
  HT["Hunt Type"] AD["🔐 Active Directory\n405 pts"] SEC["🗝️ Secrets/Identity\n270 pts"] INFRA["🖥️ Infrastructure\n270 pts"] APPS["📱 Applications\n135 pts"]
  ROW1["1 · Scheduled Tasks"] A1["405"] B1["270"] C1["270"] D1["135"]
  ROW2["2 · Process Spawning"] A2["405"] B2["270"] C2["270"] D2["135"]
  ROW3["3 · Service Creation"] A3["405"] B3["270"] C3["270"] D3["135"]
  ROW4["4 · Package Manager"] A4["405"] B4["270"] C4["270"] D4["135"]
  ROW5["5 · Data Staging"] A5["405"] B5["270"] C5["270"] D5["135"]
  ROW6["6 · Lateral Movement"] A6["405"] B6["270"] C6["270"] D6["135"]
  ROW7["7 · Registry Persistence"] A7["405"] B7["270"] C7["270"] D7["135"]
  ROW8["8 · Privilege Escalation"] A8["405"] B8["270"] C8["270"] D8["135"]
  ROW9["9 · Net Share Enum"] A9["405"] B9["270"] C9["270"] D9["135"]
  ROW10["10 · Cloud Anomalies"] A10["405"] B10["270"] C10["270"] D10["135"]
```
...
**Risk Score: 270 pts** | Trifecta Required (CTI + Hunt + Detection)
...
**Risk Score: 135 pts** | Trifecta Required (CTI + Hunt + Detection)
