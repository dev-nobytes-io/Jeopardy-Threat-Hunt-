# Hunt Jeopardy — Class 1 | Production

> Campaign: Class 1 | Environment: PROD | Base Score: 180 pts | Env Multiplier: 2.0×

---

## Scoring Formula

Risk Score = 180 (base) × 2.0 (env) × domain privilege multiplier

| Domain | Privilege Multiplier | Score per Card |
|--------|---------------------|----------------|
| 🔐 Active Directory | 3× | **1080 pts** |
| 🗝️ Secrets/Identity | 2× | **720 pts** |
| 🖥️ Infrastructure | 2× | **720 pts** |
| 📱 Applications | 1× | **360 pts** |

**Total Available Points: 28800 pts** (40 cards — trifecta required for each)
...
block-beta
  columns 5
  HT["Hunt Type"] AD["🔐 Active Directory\n1080 pts"] SEC["🗝️ Secrets/Identity\n720 pts"] INFRA["🖥️ Infrastructure\n720 pts"] APPS["📱 Applications\n360 pts"]
  ROW1["1 · Scheduled Tasks"] A1["1080"] B1["720"] C1["720"] D1["360"]
  ROW2["2 · Process Spawning"] A2["1080"] B2["720"] C2["720"] D2["360"]
  ROW3["3 · Service Creation"] A3["1080"] B3["720"] C3["720"] D3["360"]
  ROW4["4 · Package Manager"] A4["1080"] B4["720"] C4["720"] D4["360"]
  ROW5["5 · Data Staging"] A5["1080"] B5["720"] C5["720"] D5["360"]
  ROW6["6 · Lateral Movement"] A6["1080"] B6["720"] C6["720"] D6["360"]
  ROW7["7 · Registry Persistence"] A7["1080"] B7["720"] C7["720"] D7["360"]
  ROW8["8 · Privilege Escalation"] A8["1080"] B8["720"] C8["720"] D8["360"]
  ROW9["9 · Net Share Enum"] A9["1080"] B9["720"] C9["720"] D9["360"]
  ROW10["10 · Cloud Anomalies"] A10["1080"] B10["720"] C10["720"] D10["360"]
```
...
**Risk Score: 720 pts** | Trifecta Required (CTI + Hunt + Detection)
