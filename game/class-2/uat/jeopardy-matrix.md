# Hunt Jeopardy — Class 2 | UAT

> Campaign: Class 2 | Environment: UAT | Base Score: 225 pts | Env Multiplier: 1.5×

---

## Scoring Formula

Risk Score = 225 (base) × 1.5 (env) × domain privilege multiplier

| Domain | Privilege Multiplier | Score per Card |
|--------|---------------------|----------------|
| 🔐 Active Directory | 3× | **1012 pts** |
| 🗝️ Secrets/Identity | 2× | **675 pts** |
| 🖥️ Infrastructure | 2× | **675 pts** |
| 📱 Applications | 1× | **337 pts** |

**Total Available Points: 26990 pts** (40 cards — trifecta required for each)
...
block-beta
  columns 5
  HT["Hunt Type"] AD["🔐 Active Directory\n1012 pts"] SEC["🗝️ Secrets/Identity\n675 pts"] INFRA["🖥️ Infrastructure\n675 pts"] APPS["📱 Applications\n337 pts"]
  ROW1["1 · Scheduled Tasks"] A1["1012"] B1["675"] C1["675"] D1["337"]
  ROW2["2 · Process Spawning"] A2["1012"] B2["675"] C2["675"] D2["337"]
  ROW3["3 · Service Creation"] A3["1012"] B3["675"] C3["675"] D3["337"]
  ROW4["4 · Package Manager"] A4["1012"] B4["675"] C4["675"] D4["337"]
  ROW5["5 · Data Staging"] A5["1012"] B5["675"] C5["675"] D5["337"]
  ROW6["6 · Lateral Movement"] A6["1012"] B6["675"] C6["675"] D6["337"]
  ROW7["7 · Registry Persistence"] A7["1012"] B7["675"] C7["675"] D7["337"]
  ROW8["8 · Privilege Escalation"] A8["1012"] B8["675"] C8["675"] D8["337"]
  ROW9["9 · Net Share Enum"] A9["1012"] B9["675"] C9["675"] D9["337"]
  ROW10["10 · Cloud Anomalies"] A10["1012"] B10["675"] C10["675"] D10["337"]
```
...
**Risk Score: 1012 pts** | Trifecta Required (CTI + Hunt + Detection)
...
**Risk Score: 675 pts** | Trifecta Required (CTI + Hunt + Detection)
...
**Risk Score: 337 pts** | Trifecta Required (CTI + Hunt + Detection)
