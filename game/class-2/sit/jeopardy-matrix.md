# Hunt Jeopardy — Class 2 | SIT

> Campaign: Class 2 | Environment: SIT | Base Score: 225 pts | Env Multiplier: 0.75×

---

## Scoring Formula

Risk Score = 225 (base) × 0.75 (env) × domain privilege multiplier

| Domain | Privilege Multiplier | Score per Card |
|--------|---------------------|----------------|
| 🔐 Active Directory | 3× | **506 pts** |
| 🗝️ Secrets/Identity | 2× | **337 pts** |
| 🖥️ Infrastructure | 2× | **337 pts** |
| 📱 Applications | 1× | **168 pts** |

**Total Available Points: 13480 pts** (40 cards — trifecta required for each)
...
block-beta
  columns 5
  HT["Hunt Type"] AD["🔐 Active Directory\n506 pts"] SEC["🗝️ Secrets/Identity\n337 pts"] INFRA["🖥️ Infrastructure\n337 pts"] APPS["📱 Applications\n168 pts"]
  ROW1["1 · Scheduled Tasks"] A1["506"] B1["337"] C1["337"] D1["168"]
  ROW2["2 · Process Spawning"] A2["506"] B2["337"] C2["337"] D2["168"]
  ROW3["3 · Service Creation"] A3["506"] B3["337"] C3["337"] D3["168"]
  ROW4["4 · Package Manager"] A4["506"] B4["337"] C4["337"] D4["168"]
  ROW5["5 · Data Staging"] A5["506"] B5["337"] C5["337"] D5["168"]
  ROW6["6 · Lateral Movement"] A6["506"] B6["337"] C6["337"] D6["168"]
  ROW7["7 · Registry Persistence"] A7["506"] B7["337"] C7["337"] D7["168"]
  ROW8["8 · Privilege Escalation"] A8["506"] B8["337"] C8["337"] D8["168"]
  ROW9["9 · Net Share Enum"] A9["506"] B9["337"] C9["337"] D9["168"]
  ROW10["10 · Cloud Anomalies"] A10["506"] B10["337"] C10["337"] D10["168"]
```
...
**Risk Score: 506 pts** | Trifecta Required (CTI + Hunt + Detection)
...
**Risk Score: 168 pts** | Trifecta Required (CTI + Hunt + Detection)
