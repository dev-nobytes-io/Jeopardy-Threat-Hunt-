# Hunt Jeopardy — Class 2 | Non-Prod

> Campaign: Class 2 | Environment: NON-PROD | Base Score: 225 pts | Env Multiplier: 1.0×

---

## Scoring Formula

Risk Score = 225 (base) × 1.0 (env) × domain privilege multiplier

| Domain | Privilege Multiplier | Score per Card |
|--------|---------------------|----------------|
| 🔐 Active Directory | 3× | **675 pts** |
| 🗝️ Secrets/Identity | 2× | **450 pts** |
| 🖥️ Infrastructure | 2× | **450 pts** |
| 📱 Applications | 1× | **225 pts** |

**Total Available Points: 18000 pts** (40 cards — trifecta required for each)
...
block-beta
  columns 5
  HT["Hunt Type"] AD["🔐 Active Directory\n675 pts"] SEC["🗝️ Secrets/Identity\n450 pts"] INFRA["🖥️ Infrastructure\n450 pts"] APPS["📱 Applications\n225 pts"]
  ROW1["1 · Scheduled Tasks"] A1["675"] B1["450"] C1["450"] D1["225"]
  ROW2["2 · Process Spawning"] A2["675"] B2["450"] C2["450"] D2["225"]
  ROW3["3 · Service Creation"] A3["675"] B3["450"] C3["450"] D3["225"]
  ROW4["4 · Package Manager"] A4["675"] B4["450"] C4["450"] D4["225"]
  ROW5["5 · Data Staging"] A5["675"] B5["450"] C5["450"] D5["225"]
  ROW6["6 · Lateral Movement"] A6["675"] B6["450"] C6["450"] D6["225"]
  ROW7["7 · Registry Persistence"] A7["675"] B7["450"] C7["450"] D7["225"]
  ROW8["8 · Privilege Escalation"] A8["675"] B8["450"] C8["450"] D8["225"]
  ROW9["9 · Net Share Enum"] A9["675"] B9["450"] C9["450"] D9["225"]
  ROW10["10 · Cloud Anomalies"] A10["675"] B10["450"] C10["450"] D10["225"]
```
...
**Risk Score: 225 pts** | Trifecta Required (CTI + Hunt + Detection)
