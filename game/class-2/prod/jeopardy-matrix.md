# Hunt Jeopardy — Class 2 | Production

> Campaign: Class 2 | Environment: PROD | Base Score: 225 pts | Env Multiplier: 2.0×

---

## Scoring Formula

Risk Score = 225 (base) × 2.0 (env) × domain privilege multiplier

| Domain | Privilege Multiplier | Score per Card |
|--------|---------------------|----------------|
| 🔐 Active Directory | 3× | **1350 pts** |
| 🗝️ Secrets/Identity | 2× | **900 pts** |
| 🖥️ Infrastructure | 2× | **900 pts** |
| 📱 Applications | 1× | **450 pts** |

**Total Available Points: 36000 pts** (40 cards — trifecta required for each)
...
block-beta
  columns 5
  HT["Hunt Type"] AD["🔐 Active Directory\n1350 pts"] SEC["🗝️ Secrets/Identity\n900 pts"] INFRA["🖥️ Infrastructure\n900 pts"] APPS["📱 Applications\n450 pts"]
  ROW1["1 · Scheduled Tasks"] A1["1350"] B1["900"] C1["900"] D1["450"]
  ROW2["2 · Process Spawning"] A2["1350"] B2["900"] C2["900"] D2["450"]
  ROW3["3 · Service Creation"] A3["1350"] B3["900"] C3["900"] D3["450"]
  ROW4["4 · Package Manager"] A4["1350"] B4["900"] C4["900"] D4["450"]
  ROW5["5 · Data Staging"] A5["1350"] B5["900"] C5["900"] D5["450"]
  ROW6["6 · Lateral Movement"] A6["1350"] B6["900"] C6["900"] D6["450"]
  ROW7["7 · Registry Persistence"] A7["1350"] B7["900"] C7["900"] D7["450"]
  ROW8["8 · Privilege Escalation"] A8["1350"] B8["900"] C8["900"] D8["450"]
  ROW9["9 · Net Share Enum"] A9["1350"] B9["900"] C9["900"] D9["450"]
  ROW10["10 · Cloud Anomalies"] A10["1350"] B10["900"] C10["900"] D10["450"]
```
...
#### 🔐 Scheduled Tasks × Active Directory [PROD]
**Risk Score: 1350 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Scheduled Tasks × Secrets/Identity [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Scheduled Tasks × Infrastructure [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Scheduled Tasks × Applications [PROD]
**Risk Score: 450 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🔐 Process Spawning Velocity × Active Directory [PROD]
**Risk Score: 1350 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Process Spawning Velocity × Secrets/Identity [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Process Spawning Velocity × Infrastructure [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Process Spawning Velocity × Applications [PROD]
**Risk Score: 450 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🔐 Service/Daemon Creation × Active Directory [PROD]
**Risk Score: 1350 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Service/Daemon Creation × Secrets/Identity [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Service/Daemon Creation × Infrastructure [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Service/Daemon Creation × Applications [PROD]
**Risk Score: 450 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🔐 Package Manager Activity × Active Directory [PROD]
**Risk Score: 1350 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Package Manager Activity × Secrets/Identity [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Package Manager Activity × Infrastructure [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Package Manager Activity × Applications [PROD]
**Risk Score: 450 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🔐 Data Staging × Active Directory [PROD]
**Risk Score: 1350 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Data Staging × Secrets/Identity [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Data Staging × Infrastructure [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Data Staging × Applications [PROD]
**Risk Score: 450 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🔐 Lateral Movement × Active Directory [PROD]
**Risk Score: 1350 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Lateral Movement × Secrets/Identity [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Lateral Movement × Infrastructure [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Lateral Movement × Applications [PROD]
**Risk Score: 450 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🔐 Registry Persistence × Active Directory [PROD]
**Risk Score: 1350 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Registry Persistence × Secrets/Identity [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Registry Persistence × Infrastructure [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Registry Persistence × Applications [PROD]
**Risk Score: 450 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🔐 Privilege Escalation × Active Directory [PROD]
**Risk Score: 1350 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Privilege Escalation × Secrets/Identity [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Privilege Escalation × Infrastructure [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Privilege Escalation × Applications [PROD]
**Risk Score: 450 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🔐 Net Share Enum × Active Directory [PROD]
**Risk Score: 1350 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Net Share Enum × Secrets/Identity [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Net Share Enum × Infrastructure [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Net Share Enum × Applications [PROD]
**Risk Score: 450 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🔐 Cloud Anomalies × Active Directory [PROD]
**Risk Score: 1350 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Cloud Anomalies × Secrets/Identity [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Cloud Anomalies × Infrastructure [PROD]
**Risk Score: 900 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Cloud Anomalies × Applications [PROD]
**Risk Score: 450 pts** | Trifecta Required (CTI + Hunt + Detection)
