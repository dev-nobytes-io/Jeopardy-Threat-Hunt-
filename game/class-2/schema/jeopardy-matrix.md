# Hunt Jeopardy — Class 2 | Schema

> Campaign: Class 2 | Environment: SCHEMA | Base Score: 225 pts | Env Multiplier: 1.75×

---

## Scoring Formula

Risk Score = 225 (base) × 1.75 (env) × domain privilege multiplier

| Domain | Privilege Multiplier | Score per Card |
|--------|---------------------|----------------|
| 🔐 Active Directory | 3× | **1181 pts** |
| 🗝️ Secrets/Identity | 2× | **787 pts** |
| 🖥️ Infrastructure | 2× | **787 pts** |
| 📱 Applications | 1× | **393 pts** |

**Total Available Points: 31480 pts** (40 cards — trifecta required for each)
...
block-beta
  columns 5
  HT["Hunt Type"] AD["🔐 Active Directory\n1181 pts"] SEC["🗝️ Secrets/Identity\n787 pts"] INFRA["🖥️ Infrastructure\n787 pts"] APPS["📱 Applications\n393 pts"]
  ROW1["1 · Scheduled Tasks"] A1["1181"] B1["787"] C1["787"] D1["393"]
  ROW2["2 · Process Spawning"] A2["1181"] B2["787"] C2["787"] D2["393"]
  ROW3["3 · Service Creation"] A3["1181"] B3["787"] C3["787"] D3["393"]
  ROW4["4 · Package Manager"] A4["1181"] B4["787"] C4["787"] D4["393"]
  ROW5["5 · Data Staging"] A5["1181"] B5["787"] C5["787"] D5["393"]
  ROW6["6 · Lateral Movement"] A6["1181"] B6["787"] C6["787"] D6["393"]
  ROW7["7 · Registry Persistence"] A7["1181"] B7["787"] C7["787"] D7["393"]
  ROW8["8 · Privilege Escalation"] A8["1181"] B8["787"] C8["787"] D8["393"]
  ROW9["9 · Net Share Enum"] A9["1181"] B9["787"] C9["787"] D9["393"]
  ROW10["10 · Cloud Anomalies"] A10["1181"] B10["787"] C10["787"] D10["393"]
```
...
#### 🔐 Scheduled Tasks × Active Directory [SCHEMA]
**Risk Score: 1181 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Scheduled Tasks × Secrets/Identity [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Scheduled Tasks × Infrastructure [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Scheduled Tasks × Applications [SCHEMA]
**Risk Score: 393 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🔐 Process Spawning Velocity × Active Directory [SCHEMA]
**Risk Score: 1181 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Process Spawning Velocity × Secrets/Identity [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Process Spawning Velocity × Infrastructure [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Process Spawning Velocity × Applications [SCHEMA]
**Risk Score: 393 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🔐 Service/Daemon Creation × Active Directory [SCHEMA]
**Risk Score: 1181 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Service/Daemon Creation × Secrets/Identity [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Service/Daemon Creation × Infrastructure [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Service/Daemon Creation × Applications [SCHEMA]
**Risk Score: 393 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🔐 Package Manager Activity × Active Directory [SCHEMA]
**Risk Score: 1181 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Package Manager Activity × Secrets/Identity [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Package Manager Activity × Infrastructure [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Package Manager Activity × Applications [SCHEMA]
**Risk Score: 393 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🔐 Data Staging × Active Directory [SCHEMA]
**Risk Score: 1181 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Data Staging × Secrets/Identity [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Data Staging × Infrastructure [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Data Staging × Applications [SCHEMA]
**Risk Score: 393 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🔐 Lateral Movement × Active Directory [SCHEMA]
**Risk Score: 1181 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Lateral Movement × Secrets/Identity [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Lateral Movement × Infrastructure [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Lateral Movement × Applications [SCHEMA]
**Risk Score: 393 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🔐 Registry Persistence × Active Directory [SCHEMA]
**Risk Score: 1181 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Registry Persistence × Secrets/Identity [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Registry Persistence × Infrastructure [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Registry Persistence × Applications [SCHEMA]
**Risk Score: 393 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🔐 Privilege Escalation × Active Directory [SCHEMA]
**Risk Score: 1181 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Privilege Escalation × Secrets/Identity [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Privilege Escalation × Infrastructure [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Privilege Escalation × Applications [SCHEMA]
**Risk Score: 393 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🔐 Net Share Enum × Active Directory [SCHEMA]
**Risk Score: 1181 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Net Share Enum × Secrets/Identity [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Net Share Enum × Infrastructure [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Net Share Enum × Applications [SCHEMA]
**Risk Score: 393 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🔐 Cloud Anomalies × Active Directory [SCHEMA]
**Risk Score: 1181 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🗝️ Cloud Anomalies × Secrets/Identity [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 🖥️ Cloud Anomalies × Infrastructure [SCHEMA]
**Risk Score: 787 pts** | Trifecta Required (CTI + Hunt + Detection)
...
#### 📱 Cloud Anomalies × Applications [SCHEMA]
**Risk Score: 393 pts** | Trifecta Required (CTI + Hunt + Detection)
