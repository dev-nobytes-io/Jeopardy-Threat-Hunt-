# Hunt Jeopardy — Class 3 | Production

> Campaign: Class 3 | Environment: PROD | Base Score: 270 pts | Env Multiplier: 2.0×

---

## Scoring Formula

Risk Score = 270 (base) × 2.0 (env) × domain privilege multiplier

| Domain | Privilege Multiplier | Score per Card |
|--------|---------------------|----------------|
| 🔐 Active Directory | 3× | **1620 pts** |
| 🗝️ Secrets/Identity | 2× | **1080 pts** |
| 🖥️ Infrastructure | 2× | **1080 pts** |
| 📱 Applications | 1× | **540 pts** |

**Total Available Points: 43200 pts** (40 cards — trifecta required for each)
...
block-beta
  columns 5
  HT["Hunt Type"] AD["🔐 Active Directory\n1620 pts"] SEC["🗝️ Secrets/Identity\n1080 pts"] INFRA["🖥️ Infrastructure\n1080 pts"] APPS["📱 Applications\n540 pts"]
  ROW1["1 · Scheduled Tasks"] A1["1620"] B1["1080"] C1["1080"] D1["540"]
  ROW2["2 · Process Spawning"] A2["1620"] B2["1080"] C2["1080"] D2["540"]
  ROW3["3 · Service Creation"] A3["1620"] B3["1080"] C3["1080"] D3["540"]
  ROW4["4 · Package Manager"] A4["1620"] B4["1080"] C4["1080"] D4["540"]
  ROW5["5 · Data Staging"] A5["1620"] B5["1080"] C5["1080"] D5["540"]
  ROW6["6 · Lateral Movement"] A6["1620"] B6["1080"] C6["1080"] D6["540"]
  ROW7["7 · Registry Persistence"] A7["1620"] B7["1080"] C7["1080"] D7["540"]
  ROW8["8 · Privilege Escalation"] A8["1620"] B8["1080"] C8["1080"] D8["540"]
  ROW9["9 · Net Share Enum"] A9["1620"] B9["1080"] C9["1080"] D9["540"]
  ROW10["10 · Cloud Anomalies"] A10["1620"] B10["1080"] C10["1080"] D10["540"]
```
...
**Risk Score: 1620 pts** | Trifecta Required (CTI + Hunt + Detection)
...
**Risk Score: 1080 pts** | Trifecta Required (CTI + Hunt + Detection)
