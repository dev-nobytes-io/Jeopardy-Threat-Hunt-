# Hunt Jeopardy — Class 3 | Non-Prod

> Campaign: Class 3 | Environment: NON-PROD | Base Score: 270 pts | Env Multiplier: 1.0×

---

## Scoring Formula

Risk Score = 270 (base) × 1.0 (env) × domain privilege multiplier

| Domain | Privilege Multiplier | Score per Card |
|--------|---------------------|----------------|
| 🔐 Active Directory | 3× | **810 pts** |
| 🗝️ Secrets/Identity | 2× | **540 pts** |
| 🖥️ Infrastructure | 2× | **540 pts** |
| 📱 Applications | 1× | **270 pts** |

**Total Available Points: 21600 pts** (40 cards — trifecta required for each)
...
block-beta
  columns 5
  HT["Hunt Type"] AD["🔐 Active Directory\n810 pts"] SEC["🗝️ Secrets/Identity\n540 pts"] INFRA["🖥️ Infrastructure\n540 pts"] APPS["📱 Applications\n270 pts"]
  ROW1["1 · Scheduled Tasks"] A1["810"] B1["540"] C1["540"] D1["270"]
  ROW2["2 · Process Spawning"] A2["810"] B2["540"] C2["540"] D2["270"]
  ROW3["3 · Service Creation"] A3["810"] B3["540"] C3["540"] D3["270"]
  ROW4["4 · Package Manager"] A4["810"] B4["540"] C4["540"] D4["270"]
  ROW5["5 · Data Staging"] A5["810"] B5["540"] C5["540"] D5["270"]
  ROW6["6 · Lateral Movement"] A6["810"] B6["540"] C6["540"] D6["270"]
  ROW7["7 · Registry Persistence"] A7["810"] B7["540"] C7["540"] D7["270"]
  ROW8["8 · Privilege Escalation"] A8["810"] B8["540"] C8["540"] D8["270"]
  ROW9["9 · Net Share Enum"] A9["810"] B9["540"] C9["540"] D9["270"]
  ROW10["10 · Cloud Anomalies"] A10["810"] B10["540"] C10["540"] D10["270"]
```
