# Hunt Jeopardy — Class 3 | Schema

> Campaign: Class 3 | Environment: SCHEMA | Base Score: 270 pts | Env Multiplier: 1.75×

---

## Scoring Formula

Risk Score = 270 (base) × 1.75 (env) × domain privilege multiplier

| Domain | Privilege Multiplier | Score per Card |
|--------|---------------------|----------------|
| 🔐 Active Directory | 3× | **1417 pts** |
| 🗝️ Secrets/Identity | 2× | **945 pts** |
| 🖥️ Infrastructure | 2× | **945 pts** |
| 📱 Applications | 1× | **472 pts** |

**Total Available Points: 37790 pts** (40 cards — trifecta required for each)
...
block-beta
  columns 5
  HT["Hunt Type"] AD["🔐 Active Directory\n1417 pts"] SEC["🗝️ Secrets/Identity\n945 pts"] INFRA["🖥️ Infrastructure\n945 pts"] APPS["📱 Applications\n472 pts"]
  ROW1["1 · Scheduled Tasks"] A1["1417"] B1["945"] C1["945"] D1["472"]
  ROW2["2 · Process Spawning"] A2["1417"] B2["945"] C2["945"] D2["472"]
  ROW3["3 · Service Creation"] A3["1417"] B3["945"] C3["945"] D3["472"]
  ROW4["4 · Package Manager"] A4["1417"] B4["945"] C4["945"] D4["472"]
  ROW5["5 · Data Staging"] A5["1417"] B5["945"] C5["945"] D5["472"]
  ROW6["6 · Lateral Movement"] A6["1417"] B6["945"] C6["945"] D6["472"]
  ROW7["7 · Registry Persistence"] A7["1417"] B7["945"] C7["945"] D7["472"]
  ROW8["8 · Privilege Escalation"] A8["1417"] B8["945"] C8["945"] D8["472"]
  ROW9["9 · Net Share Enum"] A9["1417"] B9["945"] C9["945"] D9["472"]
  ROW10["10 · Cloud Anomalies"] A10["1417"] B10["945"] C10["945"] D10["472"]
```
...
**Risk Score: 1417 pts** | Trifecta Required (CTI + Hunt + Detection)
...
**Risk Score: 945 pts** | Trifecta Required (CTI + Hunt + Detection)
...
**Risk Score: 472 pts** | Trifecta Required (CTI + Hunt + Detection)
